import type { Locale, Rendition, Translated } from '@jecks/shared';
...
export interface MediaRef {
  ...
  /** Sizes generated by the worker; empty until processing finishes. */
  renditions?: Rendition[] | null;
  /** Dominant colour as #RRGGBB, painted while the image loads. */
